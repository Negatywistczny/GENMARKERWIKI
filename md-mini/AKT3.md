...
| :--- | :--- | :--- | :--- |
| — | Zbalansowany sygnał wzrostowy | positive | Prawidłowa objętość istoty szarej, symetryczny wzrost półkul mózgowych, stabilne i precyzyjne formowanie sieci synaptycznych. |
| — | Sygnały GWAS | neutral | Subtelne różnice w tempie proliferacji, korelujące z ogólną sprawnością przetwarzania informacji bez anomalii strukturalnych. |
