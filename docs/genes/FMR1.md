[Strona główna](../../README.md) > [Dokumentacja](../README.md) > [Karty Genów](00_indeks.md) > [FMR1](FMR1.md)
...
| :--- | :--- | :--- |
| **Normalny (5–44 CGG)** | Prawidłowa ekspresja FMRP | Normotypowy rozwój |
| **Premutacja (55–200 CGG)** | Podwyższona ekspresja mRNA; toksyczność RNA | FXTAS (ataksja, demencja u mężczyzn); FXPOI u kobiet |
| **Pełna mutacja (>200 CGG)** | Hipermetylacja; brak FMRP | Zespół łamliwego X: ID, ASD, makroorchidyzm, dysmorfia |
**rs2043856428 (c.79G>A, p.Ser27Ter, rzadki)**

| Genotyp | Aktywność / ekspresja | Wpływ fenotypowy (kliniczny i funkcjonalny) |
| :--- | :--- | :--- |
| **★ G/G** | Prawidłowe FMRP | Norma |
| **G/A** | Nonsense; brak FMRP | Fenotyp podobny do FXS (hemizygot u ♂) |
...
* **Afryka (AFR):** Wyższa częstość premutacji w niektórych populacjach
* **Azja Wschodnia (EAS):** Niższa częstość FXS w niektórych kohortach
* **Uwagi o zmienności populacyjnej:** Ekspansja niestabilna — ryzyko wzrostu CGG u potomstwa; AGG interruptions spowalniają ekspansję.
...
### 7. Ciekawostki
* „Łamliwy X” od widocznego przerwania chromosomu X w kulturze komórkowej.
* FMRP to jeden z najważniejszych regulatorów translacji w synapsach.
* Premutacja może powodować zupełnie inne choroby (FXTAS) niż pełna mutacja (FXS).

### 8. Źródła (Referencje)
* **PMID: 1710175** (Verkerk AJ et al., 1991) – Klonowanie FMR1 i ekspansja CGG.
* **PMID: 35002287** (Berry-Kravis E et al., 2022) – Metformina w FXS.
* **PMID: 29603880** (Hagerman RJ et al., 2017) – FXTAS i FXPOI.
* **Baza referencyjna:** [SNPedia (FMR1)](https://www.snpedia.com/index.php/FMR1) – Ekspansje CGG i fenotypy.
