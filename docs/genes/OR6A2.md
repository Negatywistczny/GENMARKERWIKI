[Strona główna](../../README.md) > [Dokumentacja](../README.md) > [Karty Genów](00_indeks.md) > [OR6A2](OR6A2.md)
...
* **Azja Południowa / Ameryka Łacińska:** Wyższa tolerancja kulinarowa; niższa deklarowana awersja mimo podobnego MAF
* **Azja Wschodnia (EAS):** Rozbieżność: genotyp vs deklarowana niechęć (do ~20% ankiet) — rola TAS2R i kultury
...
* **Julia Child:** Genotyp C/C (rs72921001) — słynna niechęć do kolendry; rada „rzucenia na podłogę” w restauracji.
