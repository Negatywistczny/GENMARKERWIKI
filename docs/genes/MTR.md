[Strona główna](../../README.md) > [Dokumentacja](../README.md) > [Karty Genów](00_indeks.md) > [MTR](MTR.md)
...
* **Afryka (AFR):** MAF G ~15–18%
* **Azja Wschodnia (EAS):** MAF G ~25–30%
* **Uwagi o zmienności populacyjnej:** Interpretacja zawsze łącznie z MTHFR (C677T) i MTRR (A66G)
...
### 7. Ciekawostki
* **Paradoks G919:** Allel G zwiększa aktywność enzymu, ale przy niedoborze B12 może przyspieszyć „zamrożenie” kofaktora — szybszy enzym ≠ zawsze lepszy metabolizm.
* **cblG vs rs1805087:** Rzadka mutacja homozygotyczna cblG to ciężka choroba metaboliczna; wariant populacyjny A2756G to zupełnie inna skala ryzyka.
* **SAMe i metionina:** MTR dostarcza metioninę do cyklu metylacji — łączy genetykę lipidową (homocysteina) z metylacją DNA i neurotransmiterów.

### 8. Źródła (Referencje)
* **PMID: 8640230** (Harmon et al., 1996) – Polimorfizm A2756G (D919G) syntazy metioninowej.
* **PMID: 15797999** (Dekou et al., 2005) – MTR A2756G a homocysteina i status witaminy B12.
* **PMID: 19193632** (Hoffman et al., 2009) – Interakcje MTR, MTRR i MTHFR w metabolizmie homocysteiny.
* **Baza referencyjna:** [SNPedia (rs1805087)](https://www.snpedia.com/index.php/Rs1805087) – A2756G, B12 i homocysteina.
