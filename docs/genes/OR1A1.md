[Strona główna](../../README.md) > [Dokumentacja](../README.md) > [Karty Genów](00_indeks.md) > [OR1A1](OR1A1.md)
...
* **Afryka (AFR):** Dane ograniczone; prawdopodobnie niższa częstość anosmii specyficznej
* **Azja Wschodnia (EAS):** Brak pełnych tabel genotypowych w kohortach publicznych
* **Uwagi o zmienności populacyjnej:** Klaster OR na chr. 17 — wysoka reorganizacja i duplikacje między populacjami
...
### 7. Ciekawostki
* **Kolendra: „mydło” vs „świeżość”:** Debata o smaku kolendry wynika części z OR1A1 — nosiciele funkcjonalnego allelu czują karwon, inni (T/T) nie.
* **~400 genów OR u człowieka:** OR1A1 to jeden z nielicznych z dobrze opisaną anosmią specyficzną; większość receptorów węchowych pozostaje słabo zmapowana fenotypowo.
* **Pseudogeny:** Część alleli w klastrze chr. 17 to pseudogeny — ewolucyjny „cement” utraty funkcji bez utraty całego węchu.
