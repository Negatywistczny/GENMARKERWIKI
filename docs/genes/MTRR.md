[Strona główna](../../README.md) > [Dokumentacja](../README.md) > [Karty Genów](00_indeks.md) > [MTRR](MTRR.md)
...
* **Afryka (AFR):** MAF G ~20%
* **Azja Wschodnia (EAS):** MAF G ~30–35%; rs1532268 T częstszy
* **Uwagi o zmienności populacyjnej:** Haplotyp A66G + MTHFR 677T kumuluje ryzyko metaboliczne
...
### 7. Ciekawostki
* **Recykling kofaktora:** MTRR „ożywia” unieaktywnioną kobalaminę — bez niej MTR staje się bezużyteczny mimo prawidłowej sekwencji genu MTR.
* **Triada metylacji:** MTHFR + MTR + MTRR to klasyczny panel interpretowany łącznie w nutrigenetyce; pojedynczy MTRR daje tylko część obrazu.
* **NADPH i SAMe:** Reduktaza MSR wymaga NADPH i jest modulowana przez SAMe — łączy metabolizm energetyczny z cyklem metioninowym.

### 8. Źródła (Referencje)
* **PMID: 10527505** (Wilson et al., 1999) – Polimorfizm A66G reduktazy metioninowej (MTRR).
* **PMID: 15797999** (Dekou et al., 2005) – MTRR I22M a homocysteina i witamina B12.
* **PMID: 19193632** (Hoffman et al., 2009) – Wspólne działanie MTHFR, MTR i MTRR.
* **Baza referencyjna:** [SNPedia (rs1801394)](https://www.snpedia.com/index.php/Rs1801394) – A66G, recykling B12 i homocysteina.
