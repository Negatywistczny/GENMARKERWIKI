[Strona główna](../../README.md) > [Dokumentacja](../README.md) > [Minikarty Genów](README.md) > [ST3GAL3](ST3GAL3.md)
...
| :--- | :--- | :--- | :--- |
| **★ T/T** | Prawidłowa sialilacja synaptyczna | positive | W pełni funkcjonalne, prawidłowo "oglikozylowane" receptory i cząsteczki adhezyjne. Optymalna plastyczność synaptyczna i wysoka sprawność kognitywna. |
| **T/C** | Średnia wydajność | neutral | Standardowa bezobjawowa zmienność w strukturze oligosacharydowej błon komórkowych. |
| **C/C** | Heterozygota/Homozygota LoF | negative | Ciężka, autosomalna recesywna niepełnosprawność intelektualna (MRT12). Brak prawidłowej sialilacji uniemożliwia fizyczną stabilizację synaps w hipokampie i korze mózgowej. Objawia się głębokim opóźnieniem rozwoju mowy, regressem poznawczym, dyspraksją oraz ciężkim fenotypem autystycznym (ASD). |
