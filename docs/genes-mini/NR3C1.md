[Strona główna](../../README.md) > [Dokumentacja](../README.md) > [Minikarty Genów](00_indeks.md) > [NR3C1](NR3C1.md)
...
* **Główny rsID / wariant:** rs41423247
...
| :--- | :--- | :--- | :--- |
| **★ G/G** | Wysoka czułość na kortyzol / Podatność na stres | positive | Nadreaktywność na glukokortykoidy. Błyskawiczne wygaszanie osi HPA, ale kosztem skłonności do chronicznie niskiego poziomu spoczynkowego kortyzolu (hipokortyzolemia). Silna korelacja z zespołem stresu pourazowego (PTSD), wypaleniem zawodowym i chronicznym zmęczeniem. |
| **G/C** | Pośredni | neutral | Prawidłowa, plastyczna odpowiedź receptorowa na stres środowiskowy. |
| **C/C** | Niska czułość na kortyzol / Rezyliencja | negative | Zmniejszona wrażliwość receptora GR. Oś HPA potrzebuje więcej czasu na wygaszenie (dłuższy wyrzut kortyzolu), co daje wysoką wrodzoną odporność na traumę psychologiczną i brak ulegania paraliżowi w kryzysie. |
