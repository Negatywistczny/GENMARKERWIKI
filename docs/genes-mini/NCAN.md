[Strona główna](../../README.md) > [Dokumentacja](../README.md) > [Minikarty Genów](00_indeks.md) > [NCAN](NCAN.md)
...
| :--- | :--- | :--- | :--- |
| **A/A** | Wariant standardowy | positive | Stabilna, prawidłowo uwodniona macierz zewnątrzkomórkowa. Dobrze wykształcone sieci perineuronalne chroniące neurony GABAergiczne, wysoka stabilność neurochemiczna. |
| **A/G** | Pośredni | neutral | Standardowa elastyczność i gęstość macierzy tkanki nerwowej. |
| **★ G/G** | Wariant ryzyka afektywnego | negative | Zmieniona struktura neurokanu upośledza formowanie sieci perineuronalnych wokół neuronów hamujących. Skutkuje to utratą osłony komórkowej i podatnością na destabilizację elektrofizjologiczną. W badaniach genomicznych wariant ten wykazuje potężną, powtarzalną asocjację z **chorobą afektywną dwubiegunową (ChAD)**, manią oraz epizodami psychotycznymi. |
